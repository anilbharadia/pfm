...
@Component({
    selector: 'jhi-recurring-deposit',
    templateUrl: './recurring-deposit.component.html'
})
export class RecurringDepositComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/recurring-deposit'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: RecurringDeposit) {
        return item.id;
    }
    registerChangeInRecurringDeposits() {
        this.eventSubscriber = this.eventManager.subscribe('recurringDepositListModification', (response) => this.loadAll());
    }
