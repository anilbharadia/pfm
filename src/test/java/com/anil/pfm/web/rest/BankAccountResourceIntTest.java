...
public class BankAccountResourceIntTest {
    ...
    private static final String DEFAULT_AC_NUMBER = "AAAAAAAAAA";
    private static final String UPDATED_AC_NUMBER = "BBBBBBBBBB";

    private static final String DEFAULT_IFSC = "AAAAAAAAAA";
    private static final String UPDATED_IFSC = "BBBBBBBBBB";

    private static final String DEFAULT_MICR = "AAAAAAAAAA";
    private static final String UPDATED_MICR = "BBBBBBBBBB";
    ...
    public void createBankAccount() throws Exception {
        ...
        assertThat(testBankAccount.getAcNumber()).isEqualTo(DEFAULT_AC_NUMBER);
        assertThat(testBankAccount.getIfsc()).isEqualTo(DEFAULT_IFSC);
        assertThat(testBankAccount.getMicr()).isEqualTo(DEFAULT_MICR);
    }
    ...
    @Test
    @Transactional
    public void checkAcNumberIsRequired() throws Exception {
        int databaseSizeBeforeTest = bankAccountRepository.findAll().size();
        // set the field null
        bankAccount.setAcNumber(null);
    ...
    public void getAllBankAccounts() throws Exception {
        ...
        restBankAccountMockMvc.perform(get("/api/bank-accounts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].acNumber").value(hasItem(DEFAULT_AC_NUMBER.toString())))
            .andExpect(jsonPath("$.[*].ifsc").value(hasItem(DEFAULT_IFSC.toString())))
            .andExpect(jsonPath("$.[*].micr").value(hasItem(DEFAULT_MICR.toString())));
    }
    ...
    public void getBankAccount() throws Exception {
        ...
        restBankAccountMockMvc.perform(get("/api/bank-accounts/{id}", bankAccount.getId()))
            ...
            .andExpect(jsonPath("$.acNumber").value(DEFAULT_AC_NUMBER.toString()))
            .andExpect(jsonPath("$.ifsc").value(DEFAULT_IFSC.toString()))
            .andExpect(jsonPath("$.micr").value(DEFAULT_MICR.toString()));
    }
    ...
    public void updateBankAccount() throws Exception {
        ...
        BankAccount testBankAccount = bankAccountList.get(bankAccountList.size() - 1);
        assertThat(testBankAccount.getAcNumber()).isEqualTo(UPDATED_AC_NUMBER);
        assertThat(testBankAccount.getIfsc()).isEqualTo(UPDATED_IFSC);
        assertThat(testBankAccount.getMicr()).isEqualTo(UPDATED_MICR);
    }
